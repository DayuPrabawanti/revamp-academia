...
type BootcampBatch struct {
	BatchID           sql.NullInt32          `db:"batch_id" json:"batchId"`
	BatchEntityID     sql.NullInt32          `db:"batch_entity_id" json:"batchEntityId"`
...
type HrDepartment struct {
	DeptID           sql.NullInt64          `db:"dept_id" json:"deptId"`
...
type HrEmployee struct {
	EmpEntityID       sql.NullInt64          `db:"emp_entity_id" json:"empEntityId"`
	...
	EmpJoroID         sql.NullInt64  `db:"emp_joro_id" json:"empJoroId"`
	EmpEmpEntityID    sql.NullInt64  `db:"emp_emp_entity_id" json:"empEmpEntityId"`
}
...
type JobhireClient struct {
	ClitID           sql.NullInt32          `db:"clit_id" json:"clitId"`
...
type JobhireEmployeeRange struct {
	EmraID           sql.NullInt32         `db:"emra_id" json:"emraId"`
...
type JobhireJobCategory struct {
	JocaID           sql.NullInt32          `db:"joca_id" json:"jocaId"`
...
type JobhireJobPhoto struct {
	JophoID           sql.NullInt32          `db:"jopho_id" json:"jophoId"`
...
type JobhireJobPost struct {
	JopoEntityID       sql.NullInt32          `db:"jopo_entity_id" json:"jopoEntityId"`
...
type JobhireTalentApply struct {
	TaapUserEntityID sql.NullInt32          `db:"taap_user_entity_id" json:"taapUserEntityId"`
	TaapEntityID     sql.NullInt32          `db:"taap_entity_id" json:"taapEntityId"`
...
type JobhireTalentApplyProgress struct {
	TaprID           sql.NullInt32          `db:"tapr_id" json:"taprId"`
	TaapUserEntityID sql.NullInt32          `db:"taap_user_entity_id" json:"taapUserEntityId"`
	TaapEntityID     sql.NullInt32          `db:"taap_entity_id" json:"taapEntityId"`
...
type MasterJobRole struct {
	JoroID           sql.NullInt32          `db:"joro_id" json:"joroId"`
