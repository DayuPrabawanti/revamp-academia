...
type DepartmentHistoryController struct {
	departmentHistoryService *hr.DepartmentHistoryService
}

// declare constructor
func NewDepartmentHistoryController(departmentHistoryService *hr.DepartmentHistoryService) *DepartmentHistoryController {
