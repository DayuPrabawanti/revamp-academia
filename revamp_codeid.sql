...
CREATE TABLE master.status (
    ...
    status_module character varying(30),
...
ALTER TABLE public.business_entity_entity_id_seq OWNER TO postgres;
...
--
-- Name: employee_emp_entity_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.employee_emp_entity_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.employee_emp_entity_id_seq OWNER TO postgres;

--
-- Name: employee_emp_entity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.employee_emp_entity_id_seq OWNED BY public.employee.emp_entity_id;
...
--
-- Name: program_entity_entity_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.program_entity_entity_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.program_entity_entity_id_seq OWNER TO postgres;

--
-- Name: program_entity_entity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.program_entity_entity_id_seq OWNED BY public.program_entity.entity_id;


--
-- Name: program_entity_prog_entity_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.program_entity_prog_entity_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.program_entity_prog_entity_id_seq OWNER TO postgres;

--
-- Name: program_entity_prog_entity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.program_entity_prog_entity_id_seq OWNED BY public.program_entity.prog_entity_id;
...
--
-- Name: users_entity_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.users_entity_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.users_entity_id_seq OWNER TO postgres;

--
-- Name: users_entity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.users_entity_id_seq OWNED BY public.users.entity_id;


--
-- Name: users_user_entity_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.users_user_entity_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.users_user_entity_id_seq OWNER TO postgres;

--
-- Name: users_user_entity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.users_user_entity_id_seq OWNED BY public.users.user_entity_id;
...
--
-- Name: employee emp_entity_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employee ALTER COLUMN emp_entity_id SET DEFAULT nextval('public.employee_emp_entity_id_seq'::regclass);


--
-- Name: program_entity prog_entity_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.program_entity ALTER COLUMN prog_entity_id SET DEFAULT nextval('public.program_entity_prog_entity_id_seq'::regclass);


--
-- Name: program_entity entity_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.program_entity ALTER COLUMN entity_id SET DEFAULT nextval('public.program_entity_entity_id_seq'::regclass);


--
-- Name: users user_entity_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users ALTER COLUMN user_entity_id SET DEFAULT nextval('public.users_user_entity_id_seq'::regclass);


--
-- Name: users entity_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users ALTER COLUMN entity_id SET DEFAULT nextval('public.users_entity_id_seq'::regclass);
...
INSERT INTO bootcamp.batch_trainee (batr_id, batr_status, batr_certificated, batre_certificate_link, batr_access_token, batr_access_grant, batr_review, batr_total_score, batr_modified_date, batr_trainee_entity_id, batr_batch_id) VALUES (2, 'running', '0', NULL, NULL, '0', 'selama bootcamp ok nice', 86, '2023-07-06 00:00:00', 1, 1);
...
INSERT INTO bootcamp.batch_trainee_evaluation (btev_id, btev_type, btev_header, btev_section, btev_skill, btev_week, btev_skor, btev_note, btev_modified_date, btev_batch_id, btev_trainee_entity_id) VALUES (2, 'softskill', 'Fundamental', NULL, 'Database', 2, 4, NULL, '2023-07-06 00:00:00', 1, 3);
...
INSERT INTO bootcamp.instructor_programs (batch_id, inpro_entity_id, inpro_emp_entity_id, inpro_modified_date) VALUES (1, 2, 1, NULL);
INSERT INTO bootcamp.instructor_programs (batch_id, inpro_entity_id, inpro_emp_entity_id, inpro_modified_date) VALUES (1, 2, 4, NULL);
...
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (4, 'Javascript Fullstack From Zero To Expert', 'Modern javascript for everyone with projects, challenge and theory. More Course in one !', 'course', 'online', NULL, NULL, NULL, 'javascript.png', NULL, 750, 'bahasa', NULL, NULL, NULL, 1, 2, NULL, 'publish');
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (5, 'Java Technology', 'Join bootcamp and become java developer', 'bootcamp', 'online', NULL, NULL, NULL, 'java.png', NULL, NULL, NULL, NULL, NULL, NULL, 2, 3, NULL, NULL);
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (6, 'Golang', 'Develop application with golang', 'course', 'online', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, NULL, NULL);
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (7, 'Javascript Fullstack From Zero To Expert', 'Modern javascript for everyone with projects, challenge and theory. More Course in one !', 'course', 'online', NULL, NULL, NULL, 'javascript.png', NULL, 750, 'bahasa', NULL, NULL, NULL, 1, 2, NULL, 'publish');
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (8, 'Java Technology', 'Join bootcamp and become java developer', 'bootcamp', 'online', NULL, NULL, NULL, 'java.png', NULL, NULL, NULL, NULL, NULL, NULL, 2, 3, NULL, NULL);
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (9, 'Golang', 'Develop application with golang', 'course', 'online', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, NULL, NULL);
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (10, 'Javascript Fullstack From Zero To Expert', 'Modern javascript for everyone with projects, challenge and theory. More Course in one !', 'course', 'online', NULL, NULL, NULL, 'javascript.png', NULL, 750, 'bahasa', NULL, NULL, NULL, 1, 2, NULL, 'publish');
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (11, 'Java Technology', 'Join bootcamp and become java developer', 'bootcamp', 'online', NULL, NULL, NULL, 'java.png', NULL, NULL, NULL, NULL, NULL, NULL, 2, 3, NULL, NULL);
INSERT INTO curriculum.program_entity (prog_entity_id, prog_title, prog_headline, prog_type, prog_learning_type, prog_rating, prog_total_trainee, prog_modified_date, prog_image, prog_best_seller, prog_price, prog_language, prog_duration, prog_duration_type, prog_tag_skill, prog_city_id, prog_cate_id, prog_created_by, prog_status) VALUES (12, 'Golang', 'Develop application with golang', 'course', 'online', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, NULL, NULL);
...
INSERT INTO curriculum.program_reviews (prow_user_entity_id, prow_prog_entity_id, prow_review, prow_rating, prow_modified_date) VALUES (1, 1, 'Course javascript sangat comprehensif, mudah diikutin, trainer sangat menguasai materi', 4, '2023-02-23 00:00:00');
INSERT INTO curriculum.program_reviews (prow_user_entity_id, prow_prog_entity_id, prow_review, prow_rating, prow_modified_date) VALUES (2, 2, 'Very good, has allowed me to grasp the basic syntax and structure of Golang. Also provides effective challenges.', 7, '2023-05-30 00:00:00');
INSERT INTO curriculum.program_reviews (prow_user_entity_id, prow_prog_entity_id, prow_review, prow_rating, prow_modified_date) VALUES (3, 3, 'we going to practice variables and strings in JavaScript so you can hone your skills and feel confident taking them to the real world.', 5, '2023-03-12 00:00:00');
...
INSERT INTO jobhire.client (clit_id, clit_name, clit_about, clit_modified_date, clit_addr_id, clit_emra_id) VALUES (1, 'Code ID', 'CODE.ID is a software development service company that focuses on helping clients turn their best ideas into a product, application, or website.', NULL, NULL, NULL);
INSERT INTO jobhire.client (clit_id, clit_name, clit_about, clit_modified_date, clit_addr_id, clit_emra_id) VALUES (2, 'Telkomsel', 'adalah operator telekomunikasi seluler pertama di Indonesia yang berbasis teknologi jaringan GSM Dual Band (900 & 1800), GPRS, WiFi, EDGE, 3G, HSDPA dan HSPA di seluruh Indonesia', NULL, NULL, NULL);
INSERT INTO jobhire.client (clit_id, clit_name, clit_about, clit_modified_date, clit_addr_id, clit_emra_id) VALUES (3, 'Astra Internasional', 'PT Astra International Tbk. (IDX: ASII) adalah sebuah konglomerat multinasional yang berkantor pusat di Jakarta, Indonesia', NULL, NULL, NULL);
...
INSERT INTO jobhire.job_post (jopo_entity_id, jopo_number, jopo_title, jopo_start_date, jopo_end_date, jopo_min_salary, jopo_max_salary, jopo_min_experience, jopo_max_experience, jopo_primary_skill, jopo_secondary_skill, jopo_publish_date, jopo_modified_date, jopo_emp_entity_id, jopo_clit_id, jopo_joro_id, jopo_joty_id, jopo_joca_id, jopo_addr_id, jopo_work_code, jopo_edu_code, jopo_indu_code, jopo_status) VALUES (1, 'JOB20220727-0001', 'Java Developer', '2022-12-07 00:00:00', '2022-12-08 00:00:00', 9000000, 16000000, 1, 3, 'java,sql', NULL, NULL, NULL, 7, 3, 1, 5, 1, NULL, NULL, NULL, NULL, 'publish');
...
INSERT INTO jobhire.job_post_desc (jopo_entity_id, jopo_description, jopo_responsibility, jopo_target, jopo_benefit) VALUES (1, NULL, NULL, NULL, NULL);
...
INSERT INTO jobhire.talent_apply (taap_user_entity_id, taap_entity_id, taap_intro, taap_scoring, taap_modified_date, taap_status) VALUES (1, 1, 'Perkenalkan nama saya andhika, saya data scienties anthusias', 8, '2022-07-12 00:00:00', 'Interview');
...
INSERT INTO jobhire.talent_apply_progress (tapr_id, taap_user_entity_id, taap_entity_id, tapr_modified_date, tapr_status, tapr_comment, tapr_progress_name) VALUES (1, 1, 1, '2022-07-15 00:00:00', 'done', NULL, NULL);
INSERT INTO jobhire.talent_apply_progress (tapr_id, taap_user_entity_id, taap_entity_id, tapr_modified_date, tapr_status, tapr_comment, tapr_progress_name) VALUES (2, 1, 1, '2022-07-15 00:00:00', 'done', NULL, NULL);
INSERT INTO jobhire.talent_apply_progress (tapr_id, taap_user_entity_id, taap_entity_id, tapr_modified_date, tapr_status, tapr_comment, tapr_progress_name) VALUES (3, 1, 1, '2022-07-18 00:00:00', 'waiting', NULL, NULL);
INSERT INTO jobhire.talent_apply_progress (tapr_id, taap_user_entity_id, taap_entity_id, tapr_modified_date, tapr_status, tapr_comment, tapr_progress_name) VALUES (4, 1, 1, '2022-07-18 00:00:00', 'waiting', NULL, NULL);
...
INSERT INTO master.address (addr_id, addr_line1, addr_line2, addr_postal_code, addr_spatial_location, addr_modified_date, addr_city_id) VALUES (3, 'jl. Seramparangan no 20, sukamaju, babakan madang', '/', '67855', 'Rumah no 18', NULL, 2);
INSERT INTO master.address (addr_id, addr_line1, addr_line2, addr_postal_code, addr_spatial_location, addr_modified_date, addr_city_id) VALUES (4, 'jl.Sukarno Hatta no 21, Cibinong, Jakarta Timur', 'jl cibi', '776567', '{}', NULL, 1);
INSERT INTO master.address (addr_id, addr_line1, addr_line2, addr_postal_code, addr_spatial_location, addr_modified_date, addr_city_id) VALUES (5, 'jl. Mahakan no 65, Gorontina, Sukanda Timur', 'jl goro', '0098768', '{}', NULL, 1);
...
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('certified', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('voluntering', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('organization', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('reward', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('fulltime', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('freelance', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('bachelor', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('diploma', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Male', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Female', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Single', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Married', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Hourly', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Salaried', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Active', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('InActive', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Contract', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Prohibation', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Monthly', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Weekly', 'HR', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Bootcamp', 'Course', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Course', 'Course', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Online', 'Course', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Offline', 'Course', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('English', 'Course', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Bahasa', 'Course', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Open', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Running', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Close', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Pending', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Extend', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Passed', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Failed', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Resign', 'Bootcamp', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Publish', 'Job', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Draft', 'Job', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Cancel', 'Job', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Remove', 'Job', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Waiting', 'Job', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Done', 'Job', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('New', 'Sales', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Shipping', 'Sales', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Cancelled', 'Sales', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Refunds', 'Sales', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Closed', 'Sales', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('TopUp', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Transfer', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('PayOrder', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Refund', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Debit', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Credit', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Payment', 'Payment', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Internal', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('External', 'User', NULL);
INSERT INTO master.status (status, status_module, status_modified_date) VALUES ('Outsource', 'User', NULL);
...
INSERT INTO sales.sales_order_detail (sode_id, sode_qty, sode_unit_price, sode_unit_discount, sode_line_total, sode_modified_date, sode_sohe_id, sode_prog_entity_id) VALUES (1, 1, '100.000', '50.00', 50000, NULL, 1, 1);
...
INSERT INTO sales.special_offer_programs (soco_id, soco_spof_id, soco_prog_entity_id, soco_status, soco_modified_date) VALUES (1, 1, 1, NULL, NULL);
INSERT INTO sales.special_offer_programs (soco_id, soco_spof_id, soco_prog_entity_id, soco_status, soco_modified_date) VALUES (2, 1, 3, NULL, NULL);
...
INSERT INTO users.business_entity (entity_id) VALUES (11);
INSERT INTO users.business_entity (entity_id) VALUES (10);
INSERT INTO users.business_entity (entity_id) VALUES (12);
INSERT INTO users.business_entity (entity_id) VALUES (13);
INSERT INTO users.business_entity (entity_id) VALUES (14);
INSERT INTO users.business_entity (entity_id) VALUES (15);
INSERT INTO users.business_entity (entity_id) VALUES (16);
INSERT INTO users.business_entity (entity_id) VALUES (17);
INSERT INTO users.business_entity (entity_id) VALUES (18);
INSERT INTO users.business_entity (entity_id) VALUES (19);
...
INSERT INTO users.phone_number_type (ponty_code, ponty_modified_date) VALUES ('Home', '2022-07-12 00:00:00');
INSERT INTO users.phone_number_type (ponty_code, ponty_modified_date) VALUES ('Cell', '2022-07-12 00:00:00');
INSERT INTO users.phone_number_type (ponty_code, ponty_modified_date) VALUES ('Office', '2023-07-11 09:32:51.936822');
...
INSERT INTO users.roles (role_id, role_name, role_type, role_modified_date) VALUES (19, 'Calo', 'Eksternal', '2023-07-10 19:51:21.551962');
...
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (1, 'kangdian', 'yadfaldjfapdjf;ajfpasdf', 'kang', 'dian', NULL, 1, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'photo.png', 4);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (2, 'nofal', 'ajdfja;dfpadjfadf', 'nofal', 'firdaus', NULL, 0, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'nofal.png', 4);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (4, 'ratih', 'yadlfjadjfa', 'ratih wina', 'ludwig', NULL, 0, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'ratih.png', 11);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (6, 'novia', 'lajdfljaljdfajdf;a', 'novia', 'slebew', NULL, 1, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'novia.png', 9);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (7, 'novelina', 'lkadjfajdf;adf', 'novelina', 'lina', NULL, 0, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'lina.png', 3);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (8, 'yugo', 'aldjfadfa;dfjlajdf;a', 'yugo', 'ardan', NULL, 1, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'yugo.png', 1);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (11, 'Purwo', '12345', 'purwo', 'sandiko', '1998-08-20 12:00:00', 0, '{ "latitude" : 12.90, "longitude" : -99.989}', '2023-07-10 21:12:47.049956', 'n/a', 2);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (3, 'abdul101', 'ajdfja;dfpadjfadf', 'Abdul', 'Razaq', '1999-05-15 12:00:00', 1, '{"latitude":12.90,"longitude":-99.989}', '2023-07-12 00:00:00', 'abdul.png', 1);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (9, 'Andhika Burhan', 'ladfljafjadfas;f', 'andhika', 'pratama', '1969-01-01 00:00:00', 1, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'andhika.png', 2);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (5, 'Eka Gustiawa', 'ynyaldjf;adfadfad;faldfsa', 'Eka', 'Nugroho', NULL, 0, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'eka.png', 8);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (14, 'Budi Gustiawa', 'ynyaldjf;adfadfad;faldfsa', 'Eka', 'Nugroho', NULL, 0, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'eka.png', 8);
INSERT INTO users.users (user_entity_id, user_name, user_password, user_first_name, user_last_name, user_birth_date, user_email_promotion, user_demographic, user_modified_date, user_photo, user_current_role) VALUES (13, 'Budi Budiyono', 'ynyaldjf;adfadfad;faldfsa', 'Eka', 'Nugroho', '2000-01-01 00:00:00', 0, '{"latitude":12.90,"longitude":-99.989}', '2022-07-12 00:00:00', 'eka.png', 8);
...
INSERT INTO users.users_address (etad_addr_id, etad_modified_date, etad_entity_id, etad_adty_id) VALUES (3, '2023-07-11 07:11:55.86582', 11, 5);
...
INSERT INTO users.users_education (usdu_id, usdu_entity_id, usdu_school, usdu_degree, usdu_field_study, usdu_graduate_year, usdu_start_date, usdu_end_date, usdu_grade, usdu_activities, usdu_description, usdu_modified_date) VALUES (2, 11, 'Poltek', 'Diploma', 'Information System', '2022', '2019-09-24 10:00:00', '2022-09-25 13:00:00', '3.70', 'Im Diploma With Cumlaude', 'Never Give Up to raise the future', '2023-07-11 07:22:37.532625');
...
INSERT INTO users.users_email (pmail_entity_id, pmail_id, pmail_address, pmail_modified_date) VALUES (11, 4, 'purwo@gmail.com', '2023-07-11 07:28:58.092582');
...
INSERT INTO users.users_experiences (usex_id, usex_entity_id, usex_title, usex_profile_headline, usex_employment_type, usex_company_name, usex_is_current, usex_start_date, usex_end_date, usex_industry, usex_description, usex_experience_type, usex_city_id) VALUES (3, 11, 'Programmer', 'Backend Developer', 'Fulltime', 'PT Future Tech', '1', '2022-10-27 17:00:00', '0001-01-01 00:00:00', 'IT', 'Solve problem backend programmer', 'Company', 3);
...
INSERT INTO users.users_experiences_skill (uesk_usex_id, uesk_uski_id) VALUES (3, 3);
...
INSERT INTO users.users_license (usli_id, usli_license_code, usli_modified_date, usli_status, usli_entity_id) VALUES (1, 'AA0001', '2023-07-11 09:05:59.134178', 'Active', 11);
...
INSERT INTO users.users_media (usme_id, usme_entity_id, usme_file_link, usme_filename, usme_filesize, usme_filetype, usme_note, usme_modified_date) VALUES (1, 1, 'https://', 'ijazah.png', 2345, 'png', 'ijazah', NULL);
...
INSERT INTO users.users_media (usme_id, usme_entity_id, usme_file_link, usme_filename, usme_filesize, usme_filetype, usme_note, usme_modified_date) VALUES (3, 11, 'http://purwo', 'cv.docx', 2000, 'word', 'cv', '2023-07-11 09:12:41.432668');
...
INSERT INTO users.users_phones (uspo_entity_id, uspo_number, uspo_modified_date, uspo_ponty_code) VALUES (1, '-7890965', NULL, 'Home');
INSERT INTO users.users_phones (uspo_entity_id, uspo_number, uspo_modified_date, uspo_ponty_code) VALUES (2, '89898989', NULL, 'Cell');
INSERT INTO users.users_phones (uspo_entity_id, uspo_number, uspo_modified_date, uspo_ponty_code) VALUES (11, '081625661775', '2023-07-11 09:17:12.25754', 'Cell');
...
INSERT INTO users.users_roles (usro_entity_id, usro_role_id, usro_modified_date) VALUES (1, 1, '2022-07-12 00:00:00');
INSERT INTO users.users_roles (usro_entity_id, usro_role_id, usro_modified_date) VALUES (2, 1, '2022-07-12 00:00:00');
INSERT INTO users.users_roles (usro_entity_id, usro_role_id, usro_modified_date) VALUES (3, 3, '2022-07-12 00:00:00');
INSERT INTO users.users_roles (usro_entity_id, usro_role_id, usro_modified_date) VALUES (4, 5, '2022-07-12 00:00:00');
INSERT INTO users.users_roles (usro_entity_id, usro_role_id, usro_modified_date) VALUES (11, 2, '2023-07-11 09:36:40.665852');
...
INSERT INTO users.users_skill (uski_id, uski_entity_id, uski_modified_date, uski_skty_name) VALUES (4, 11, '2023-07-11 09:25:52.149803', 'hardskill');
INSERT INTO users.users_skill (uski_id, uski_entity_id, uski_modified_date, uski_skty_name) VALUES (5, 11, NULL, 'softskill');
...
SELECT pg_catalog.setval('curriculum.section_detail_material_sedm_id_seq', 2, true);
...
SELECT pg_catalog.setval('curriculum.section_detail_secd_id_seq', 2, true);
...
SELECT pg_catalog.setval('curriculum.sections_sect_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.business_entity_entity_id_seq', 1, false);


--
-- Name: employee_emp_entity_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.employee_emp_entity_id_seq', 1, false);


--
-- Name: program_entity_entity_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.program_entity_entity_id_seq', 1, false);


--
-- Name: program_entity_prog_entity_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.program_entity_prog_entity_id_seq', 1, false);


--
-- Name: users_entity_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.users_entity_id_seq', 1, false);


--
-- Name: users_user_entity_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.users_user_entity_id_seq', 1, false);
...
SELECT pg_catalog.setval('sales.special_offer_programs_soco_id_seq', 2, true);
...
SELECT pg_catalog.setval('users.users_eductaion_usdu_id_seq', 1, false);
...
--
-- Name: program_entity program_entity_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users_experiences usex_entity_id_pr; Type: CONSTRAINT; Schema: users; Owner: postgres
--

ALTER TABLE ONLY users.users_experiences
    ADD CONSTRAINT usex_entity_id_pr PRIMARY KEY (usex_id, usex_entity_id);
...
--
-- Name: status status_modules_fkey; Type: FK CONSTRAINT; Schema: master; Owner: postgres
--

ALTER TABLE ONLY master.status
    ADD CONSTRAINT status_modules_fkey FOREIGN KEY (status_module) REFERENCES master.modules(module_name);
...
--
-- Name: program_entity program_entity_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.program_entity
    ADD CONSTRAINT program_entity_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.business_entity(entity_id);


--
-- Name: users users_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.business_entity(entity_id);
