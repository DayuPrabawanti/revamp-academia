...
type ClientContractService struct {
	clientContractRepository *hr.ClientContractRepository
}

func NewClientContractService(clientContractRepository *hr.ClientContractRepository) *ClientContractService {
