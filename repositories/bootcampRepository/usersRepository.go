...
func (cr UserRepository) GetUser(ctx *gin.Context, id int64) (*models.UsersUser, *models.ResponseError) {

	store := dbContext.New(cr.dbHandler)
	UserEntityID, err := store.GetUser(ctx, int32(id))
