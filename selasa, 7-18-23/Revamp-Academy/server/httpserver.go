...
func InitHttpServer(config *viper.Viper, dbHandler *sql.DB) HttpServer {
	...
	router.GET("/sections/:id", progentityController.GetSection)
	router.GET("/sectiondetail", progentityController.GetListSectionDetail)
	router.GET("/mastercategory", progentityController.GetListMasterCategory)
	router.POST("/section", progentityController.CreateSection)

	router.GET("/gabung", progentityController.GetListGabung)
	router.POST("/createallgabung", progentityController.CreateGabung)
