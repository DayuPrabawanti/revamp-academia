...
SELECT  sect_prog_entity_id,sect_id, sect_title, sect_description, sect_total_section, sect_total_lecture, sect_total_minute, sect_modified_date FROM curriculum.sections
