...
import (
	...
	"codeid.revampacademy/repositories/curriculum/dbContext"
...
func (per ProgEntityRepository) GetSection(ctx *gin.Context, id int64) (*mod.CurriculumSection, *mod.ResponseError) {
